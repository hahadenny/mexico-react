...
export const PartyColors = {
  ...
  PAN: { low: "#dfe6f2", mid: "#9db2d6", high: "#2654a5", contrast: "#fff" },
  PRD: {
    low: "#fff9dd",
    mid: "#ffee99",
    high: "#feda1d",
  ...
  MC: { low: "#fdebde", mid: "#f9c39b", high: "#f27a21", contrast: "#fff" },
  PVEM: { low: "#e1f4e4", mid: "#a4ddae", high: "#35b34b", contrast: "#fff" },
  PT: { low: "#f1e9e8", mid: "#d4bcba", high: "#9f6a65", contrast: "#fff" },
  FXM: { low: "#fce8f1", mid: "#f6b9d4", high: "#ea63a0", contrast: "#fff" },
  PES: { low: "#e3dee6", mid: "#aa9ab4", high: "#422059", contrast: "#fff" },
  RSP: { low: "#ececec", mid: "#c6c7c6", high: "#808281", contrast: "#fff" },
  "PAN-PRI-PRD": {
    low: "#d9f0ee",
    mid: "#8cd1cc",
    high: "#00998f",
  ...
  INE: { low: "#f7daed", mid: "#e88ec7", high: "#cb0483", contrast: "#fff" },
  PANAL: { low: "#e9f5f9", mid: "#87c6dc", high: "#2596be", contrast: "#fff" },
  "PRI-PVEM": {
    low: "#fbdedf",
    mid: "#f29a9d",
    high: "#e21f26",
  ...
  ASDC: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" },
  "MORENA-PT-PES": {
    low2018: "#dbc6c6",
    low: "#ecdcdc",
    mid: "#c69596",
  ...
  PSD: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" },
  Independiente: {
    low: "#ffffff",
    mid: "#bebebe",
    high: "#7c7d7d",
  ...
  ES: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" },
  PH: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" },
  CONVERGENCIA: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" },
  OTHER: { low: "#ffffff", mid: "#bebebe", high: "#7c7d7d", contrast: "#fff" }
};
